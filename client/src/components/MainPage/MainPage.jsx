  ...
  return (
   <section className='main-pge-container'>
    ...
    <div className='heading'>
     ...
     <div className='main-para'> <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laborum reiciendis libero velit odio excepturi soluta exercitationem, dignissimos alias possimus a repellat quia qui temporibus ea aut totam eius, expedita aspernatur.</p></div>
