...
const logos = [{ id: 1, src: logone, alt: 'Logo 1' },{ id: 1, src: logotwo, alt: 'Logo 1' },{ id: 1, src: logothree, alt: 'Logo 1' },{ id: 1, src: logofour, alt: 'Logo 1' },
]
const carouselElements = logos.map((logo,index)=>{
   return <div className="logos-slide" key={index}>
